              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex gap-2 min-w-0">
                  <motion.button
                    ...
                    className={`flex-1 min-w-0 py-3 rounded-l-lg rounded-r-none font-semibold transition-colors border-r border-zinc-700 flex items-center justify-center ${
                      wishlistItems.has(selectedProduct.id)
                        ? 'bg-red-500 text-white'
                        : 'bg-zinc-700 text-gray-300 hover:bg-red-500 hover:text-white'
                    }`}
                    title={wishlistItems.has(selectedProduct.id) ? 'Remove from Wishlist' : 'Add to Wishlist'}
                  >
                    {/* Heart Icon */}
                  ...
                  <motion.button
                    ...
                    className={`flex-1 min-w-0 py-3 rounded-none font-semibold transition-colors border-r border-zinc-700 flex items-center justify-center ${
                      cartItems.has(selectedProduct.id)
                        ? 'bg-cyan-500 text-white'
                        : 'bg-gradient-to-r from-purple-500 to-cyan-400 text-white hover:opacity-90'
                    }`}
                    title={cartItems.has(selectedProduct.id) ? 'Remove from Cart' : 'Add to Cart'}
                  >
                    {/* Cart Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                  ...
                  <motion.button
                    ...
                    className="flex-1 min-w-0 py-3 rounded-r-lg rounded-l-none font-semibold bg-red-700 text-white hover:bg-red-600 transition flex items-center justify-center"
