  ...
  return (
    <div className="bg-zinc-900 min-h-screen flex justify-center items-center px-4 py-10">
      <motion.div
        ...
        className="bg-zinc-800 rounded-xl shadow-2xl max-w-md w-full p-8 text-white border border-cyan-500/30"
      >
        <motion.h1 
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          className="text-3xl font-bold text-center mb-6 bg-gradient-to-r from-purple-500 to-cyan-400 bg-clip-text text-transparent"
        >
          Add Product
        </motion.h1>
